...
function s:textline(left, right)
  ...
  return s:start . repeat(' ', s:framelen + 1 - strlen(s:start)) . l:leftlen .
        \repeat(' ', s:linelen - s:framelen * 2 - 2 - strlen(l:leftlen) -
        \strlen(a:right)) . a:right . repeat(' ', s:framelen - strlen(s:end) + 1)
        \. s:end
endfunction
...
function s:line(n)
  ...
  elseif a:n == 2 ||a:n == 3 || a:n == 5 || a:n == 7 || a:n == 10 || a:n == 11
...
function s:mail()
  ...
  if strlen(l:mail) == 0
    let l:mail = 'amatthys@student.le-101.fr'
  endif
  return l:mail
endfunction
